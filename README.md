...
4. it is recommended to make a `Backup` folder and to copy/paste the original STAGE.DAT before using `StageDec`, See [StageDec - STAGE.DAT Extraction/Build Tool](https://github.com/Nightshades1/Zoe2Mars_Redcase/#stagedec---stagedat-extractionbuild-tool).
